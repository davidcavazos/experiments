...
from . import penguin_model as model
from . import taxi_model as model

# DATA_PATH = "data/penguin"
DATA_PATH = "data/taxi"
...
def create_pipeline(
    ...
    evaluator = Evaluator(  # pylint: disable=unused-variable
        ...
        eval_config=tfm.Features(model.outputs).eval_config(eval_accuracy_threshold),
    )
